...
const createFlowerData = () => {
  ...
  return { name, description, price, available, occasions, tags, categories };
};

export const generateFlowers = (count: number) =>
  faker.helpers.multiple(createFlowerData, { count });
